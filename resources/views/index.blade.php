							...
							<div class="main-menu">
								...
								<div class="collapse navbar-collapse">		  
									<ul class="nav navbar-nav navbar-right">
                    					...
                    					@auth
                        					<a  class="book-btn" href="{{ url('/home') }}">Home</a>
                    					@else
										<li>
                                            <a class="book-btn" href="{{ route('login') }}">Login</a>
                                        </li>
                       						 @if (Route::has('register'))
											<li>
                                            	<a class="book-btn" href="{{ route('register') }}">Register</a>
                                        	</li>
                                    </ul>                       						 
									@endif
                    				 	@endauth
						...
						<div class="col-sm-12">
							<div class="single-about-us">
								<div class="about-us-txt">
									<h2>
                                        Jelajahi Desamu Mulai dari sini
									</h2>
									<div class="about-btn">
