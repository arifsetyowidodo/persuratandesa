                        ...
                        <div class="row">
                            <div class="page-header">
	                            <div class="d-flex align-items-center">
	                                <h2 class="page-header-title">Daftar Penduduk</h2>
	                                <div>
	                                <div class="page-header-tools">
	                                    <a class="btn btn-gradient-01" href="/backendRegisterUser">Tambah User</a>
	                                </div>
	                                </div>
	                            </div>
                            </div>
                                        ...
                                        <div class="table-responsive">
                                            <table id="export-table" class="table mb-0">
                                                ...
                                                <tbody>
                                                    @foreach($user as $p)
                                                    <tr>
                                                        <td> <span class="text-primary">{{ $p->id}}</span> </td>
                                                        <td> <span class="text-primary">{{ $p->nik}}</span> </td>
                                                        <td>{{ $p->name}}</td>
                                                        <td>{{ $p->rt}}</td>
                                                        <td>{{ $p->rw}}</td>
                                                        <td>{{ $p->notelp}}</td>
                                                        <td class="td-actions">
                                                            <a href="/backendUserDetail{{$p->id}}"><i class="la la-edit edit"></i></a>
                                                            <a href="/backendUser/hapus/{{$p->id}}"><i class="la la-close delete"></i></a>
                                                        </td>
