                        ...
                        <div class="row">
                            <div class="page-header">
	                            <div class="d-flex align-items-center">
	                                <h2 class="page-header-title">DETAIL PERSEWAAN</h2>
                                    ...
                                    <div class="widget-body">
                                        ...
                                        @foreach($persewaan as $p)
                                            <div class="form-group row d-flex align-items-center mb-5">
                                                <label class="col-lg-3 form-control-label">ID Persewaan</label>
                                                <div class="col-lg-9">
                                                     <td>{{$p->id}}</td>
                                                </div>
                                            </div>
                                            <div class="form-group row d-flex align-items-center mb-5">
                                                <label class="col-lg-3 form-control-label">NIK Pemilik</label>
                                                <div class="col-lg-9">
                                                    <input type="text" class="form-control" value={{$p->nik}}>
                                                    
                                                </div>
                                            </div>
                                            <div class="form-group row d-flex align-items-center mb-5">
                                                <label class="col-lg-3 form-control-label">Alamat Tempat</label>
                                                <div class="col-lg-9">
                                            ...
                                            <div class="form-group row d-flex align-items-center mb-5">
                                                <label class="col-lg-3 form-control-label">Panjang Bangunan</label>
                                                <div class="col-lg-9">
                                                    <div class="form-group">
                                                        <div class="input-group">
                                                            <input type="text" class="form-control" value=  {{$p->panjang}}>
                                                            <span class="input-group-addon addon-orange">Meter</span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group row d-flex align-items-center mb-5">
                                                <label class="col-lg-3 form-control-label">Lebar Bangunan</label>
                                                <div class="col-lg-9">
                                                    <div class="form-group">
                                                        <div class="input-group">
                                                            <input type="text" class="form-control" value=  {{$p->lebar}}>
                                                            <span class="input-group-addon addon-orange">Meter</span>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="form-group row d-flex align-items-center mb-5">
                                                <label class="col-lg-3 form-control-label">Luas Bangunan</label>
                                                <div class="col-lg-9">
                                                    <div class="form-group">
                                                        <div class="input-group">
                                                            <input type="text" disabled="" class="form-control" value=  {{$p->luas}}>
                                                            <span class="input-group-addon addon-orange">Meter</span>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="form-group row d-flex align-items-center mb-5">
                                                <label class="col-lg-3 form-control-label">Harga Sewa</label>
                                                <div class="col-lg-9">
                                                    <div class="form-group">
                                                        <div class="input-group">
                                                            <span class="input-group-addon addon-primary">Rp.</span>
                                                            <input type="text" class="form-control" value=  {{$p->harga}}>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group row d-flex align-items-center mb-5">
                                                <label class="col-lg-3 form-control-label">No Telepone</label>
                                                <div class="col-lg-9">
                                                    <input type="text" class="form-control" value="no tlepone">
                                            ...
                                            <div class="form-group row d-flex align-items-center mb-5">
                                                ...
                                                <div class="col-lg-9">
                                                    <img width = "1500px" src="{{url('')}}">{{$p->foto}}>
                                                </div>
                                            </div>
                                            @endforeach
                                        </div>
