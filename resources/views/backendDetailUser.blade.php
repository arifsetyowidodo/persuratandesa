                        ...
                        <div class="row">
                            <div class="page-header">
	                            <div class="d-flex align-items-center">
	                                <h2 class="page-header-title">DATA DIRI PENDUDUK</h2>
                            ...
                            <div class="col-12">
                                ...
                                <div class="widget has-shadow">
                                    <div class="widget-body">
                                         @foreach($user as $p)
                                        <form class="form-horizontal" action="backend/user/update/{{$p->id}}" method="post">
                                        {{ csrf_field() }}
                                        
                                            <div class="form-group row d-flex align-items-center mb-5">
                                                <label class="col-lg-3 form-control-label">ID Penduduk</label>
                                                <div class="col-lg-9">
                                                     <td>{{$p->id}}</td>
                                                ...
                                                <div class="col-lg-9">
                                                    <div class="form-group">
                                                        <div class="input-group">
                                                            <input type="text" name="tempatLahir" class="form-control" value=  {{$p->tempat_lahir}}>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group row d-flex align-items-center mb-5">
                                                ...
                                                <div class="col-lg-2">
                                                    <div class="form-group">
                                                        <div class="input-group">
                                                            <input type="date" name="tanggalLahir" class="form-control" value={{$p->tanggal_lahir}}>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row d-flex align-items-center mb-5">
                                                ...
                                                <div class="col-lg-9">
                                                    <div class="form-group">
                                                        <div class="input-group">
                                                            <input type="text" name="alamat" class="form-control" placeholder ="jalan / nomor rumah" value=  {{$p->alamat}}>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group row d-flex align-items-center mb-5">
                                                ...
                                                <div class="col-lg-1">
                                                    <div class="form-group">
                                                        <div class="input-group">
                                                            <input type="text" name="rt" class="form-control" placeholder ="RT" value=  {{$p->rt}}>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group row d-flex align-items-center mb-5">
                                                ...
                                                <div class="col-lg-1">
                                                    <div class="form-group">
                                                        <div class="input-group">
                                                            <input type="text" name="rw" class="form-control" placeholder ="RW" value=  {{$p->rw}}>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row d-flex align-items-center mb-5">
                                                ...
                                                <div class="col-lg-2">
                                                    <input type="text" name="agama" class="form-control" value={{$p->agama}}>
                                            ...
                                            <div class="form-group row d-flex align-items-center mb-5">
                                                ...
                                                <div class="col-lg-9">
                                                    <input type="text" name="pekerjaan" class="form-control" value={{$p->pekerjaan}}>
                                                </div>
                                            </div>
                                            <div class="form-group row d-flex align-items-center mb-5">
                                                ...
                                                <div class="col-lg-2">
                                                    <div class="form-group">
                                                        <div class="input-group">
                                                            @if ( $p->status_perkawinan == "Kawin")
                                                                <select name="statusPerkawinan" class="input-group">
                                                                    <option>{{$p->status_perkawinan}}</option>
                                            ...
                                            <div class="form-group row d-flex align-items-center mb-5">
                                                ...
                                                <div class="col-lg-2">
                                                    <input type="number" name="notelp" class="form-control" value={{$p->notelp}}>
                                                </div>
                                            </div>
                                            @endforeach
                                            <div class="form-group row d-flex align-items-center mb-5">
                                                ...
                                                <div class="col-lg-9">
                                                    <a href="/backendUser" class="btn btn-primary" >Kembali</a>
                                                    <input type="submit" class="btn btn-success" value="Perbarui Data">
                                                    <a href="/backendUser/resetPassword" class="btn btn-danger">Reset Password</a>
                                                </div>
                                            </div>
                                        </div>
                                        </form>
