...
<head>
    ...
    <!-- Core Stylesheet -->
    <link href="asset('artikel_assets/style.css')" rel="stylesheet">

    <!-- Responsive CSS -->
    <link href="asset('artikel_assets/css/responsive/responsive.css')" rel="stylesheet">
                        ...
                        <div class="col-10 col-sm-11">
                            <div class="single-post">
                                ...
                                <div class="post-thumb">
                                    <img width="550px" src="{{ url('/file_gambar/'.$ad->Foto1) }}" alt="">
                                </div>
                                <!-- Post Content -->]

                                <div class="post-content">
                                    <p>{{$ad->isi}}</p>
                               <!-- <img width="550px" src="{{ url('/file_gambar/'.$ad->Foto2) }}" alt="">-->
                        ...
                        <div class="single-widget-area popular-post-widget">
                            ...
                            <div class="single-populer-post">
                                <div class="post-contents">
                                    <a href="/detail-artikel/{{$a->id}}">
                                        <h6>{{$a->judul}}</h6>
                                    </a>
                                    <a class="post-date" href=""></a>
                                </div>
                            </div>
                        @endforeach
                        <!-- Single Widget Area -->
