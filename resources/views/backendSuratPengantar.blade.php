...
<html lang="en">
    ...
    <head>
        ...
        <title>Elisyam - Data Penduduk</title>
                    ...
                    <div class="row">
                            <div class="page-header">
	                            <div class="d-flex align-items-center">
	                                <h2 class="page-header-title">Daftar Pengajuan Surat</h2>
	                                <div>
                                        ...
                                        <div class="table-responsive">
                                            <table id="export-table" class="table mb-0">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td> <span class="text-primary">{{ $p->id_pengantar}}</span> </td>
                                                        <td>{{ $p->id_jenis_pengantar}}</td>
                                                        <td>{{ $p->NIK}}</td>
                                                        <td>Nama pengajuan surat</td>
                                                        @if( $p->status == "Proses" )
                                                            <td><span style="width:100px;"><span class="badge-text badge-text-small info">{{ $p->status}}</span></span></td>
                                                        @elseif ( $p->status == "Selesai" )
                                                            <td><span style="width:100px;"><span class="badge-text badge-text-small success">{{ $p->status}}</span></span></td>
                                                        @elseif ( $p->status == "Ditolak" )
                                                            <td><span style="width:100px;"><span class="badge-text badge-text-small danger">{{ $p->status}}</span></span></td>
                                                        @endif
                                                        <td>{{$p->create_at}}</td>
                                                        <td class="td-actions">
                                                                <a href="/backendPengajuanSuratDetail{{$p->id_pengantar}}"> <i class="la la-edit edit"> Lihat </i> </a>
                                                        </td>
