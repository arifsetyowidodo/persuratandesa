...
<html lang="en">
    <head>
        ...
        <title>Edit Profile - Dukuh Tunggal</title>
                ...
                <div class="default-sidebar">
                    ...
                    <nav class="side-navbar box-scroll sidebar-scroll">
                        ...
                        <ul class="list-unstyled">
                            ...
                            <li class="active"><a href="/edit-profile" aria-expanded="false" ><i class="la la-user"></i><span>Edit Profil</span></a></li>
                            ...
                            <div class="col-xl-3">
                                ...
                                <div class="widget has-shadow">
                                    <div class="widget-body">
                                        <div class="mt-5">
                                        <form class="form-horizontal" enctype="multipart/form-data"  method="POST" action="/edit-profile-post" >
                                        {{ csrf_field() }}
                                        @if(Auth::user()->Foto != null) 
                                            <li class="nav-item dropdown"><a id="user" rel="nofollow" data-target="#" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link"><img width = "100px" src="{{ url('/profile_pict/'.Auth::User()->Foto) }}" alt="..." class="avatar rounded-circle"></a>
                                            <i class="ion-edit"></i><span>Edit Foto <input type="file" name="foto" ></span>

                                        @else
                                            <li class="nav-item dropdown"><a id="user" rel="nofollow" data-target="#" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link"><img width = "100px" src="profile_pict/no_profile.png" alt="..." class="avatar rounded-circle"></a>
                                            <i class="ion-edit"></i><span>Edit Foto <input type="file" name="foto" ></span>
                                        @endif                                        
                                    </div>
                                        ...
                                        <li class="nav-item">
                                                <a class="nav-link" href="javascript:void(0)">{{Auth::User()->nik}}</a>
                                                <a class="nav-link" href="javascript:void(0)">{{Auth::User()->jenis_kelamin}}</a>
                                                <a class="nav-link" href="javascript:void(0)">{{Auth::User()->tempat_lahir}}, {{Auth::User()->tanggal_lahir}}</a>
                                                <a class="nav-link" href="javascript:void(0)">{{Auth::User()->rt}}/{{Auth::User()->rw}}</a>
                                                <a class="nav-link" href="javascript:void(0)">{{Auth::User()->alamat}}</a>
                            ...
                            <div class="col-xl-9">
                                <div class="widget has-shadow">
                                    ...
                                    <div class="widget-body">
                                        ...
                                        <p>*Biarkan Kosong bagian yang tidak ingin di rubah</p>


                                            <div class="form-group row d-flex align-items-center mb-5">
                                                <label class="col-lg-2 form-control-label d-flex justify-content-lg-end">Status </label>
                                                <div class="col-lg-6">
                                                <select id="jenis" type="text" class="form-control" name ="perkawinan">
                                                @if(Auth::User()->status_perkawinan == "Belum Kawin")
                                                <option value="Belum Kawin" name ="perkawinan">Belum Kawin</option>

                                                <option value="Kawin" name ="perkawinan"> Kawin</option>
                                                @else
                                                <option value="Kawin" name ="perkawinan"> Kawin</option>
                                                <option value="Belum Kawin" name ="perkawinan">Belum Kawin</option>
                                            ...
                                            <div class="form-group row d-flex align-items-center mb-5">
                                                ...
                                                <div class="col-lg-6">
                                                    <input type="number" name = "nomor" class="form-control" placeholder="{{Auth::User()->no_tlp}}">
                                                </div>
                                            </div>
                                            <div class="col-10 ml-auto">
                                           ...
                                           <div class="em-separator separator-dashed"></div>
                                           <div class="form-group row d-flex align-items-center mb-5">
                                                <label class="col-lg-2 form-control-label d-flex justify-content-lg-end">Password Sekarang</label>
                                                <div class="col-lg-6">
                                           ...
                                           <div class="text-right">
                                               <button class="btn btn-gradient-01" value = "submit" type="submit">Simpan Perubahan</button>
                                               <button class="btn btn-shadow" type="reset">Batal</button>
                                           </div>
                                        </form>
