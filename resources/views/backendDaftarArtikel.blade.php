                        ...
                        <div class="row">
                            <div class="page-header">
	                            <div class="d-flex align-items-center">
	                                <h2 class="page-header-title">Artikel</h2>
                                            ...
                                            <table id="export-table" class="table mb-0">
                                                ...
                                                @foreach($artikel as $p)
                                                    <tr>
                                                        ...
                                                        <td>{{ $p->status}}</td>
                                                        <td class="td-actions">
                                                             <a href="/backendArtikel/lihat/{{$p->id}}"><i class="la la-eye edit"></i> </a>
                                                             <a href="/backendArtikel/edit/{{$p->id}}"><i class="la la-edit edit"></i> </a>
                                                             <a href="/backendArtikel/hapus/{{$p->id}}"><i class="la la-close delete"></i> </a>
                                                        </td>
                                                    </tr>
                                                @endforeach
