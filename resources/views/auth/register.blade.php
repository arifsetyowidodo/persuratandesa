            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="col-md-6">
                                ...
                                @error('nik')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }} (NIK Telah terdaftar)</strong>
                                    </span>
                                @enderror
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            <label for="alamat" class="col-md-4 col-form-label text-md-right">{{ __('Alamat (RT/RW)') }}</label>

                            <div class="col-md-6">
                                <input id="alamat" type="text" class="form-control @error('alamat') is-invalid @enderror" name="alamat" value="{{ old('tempat') }}" required autocomplete="alamat" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                <select id="agama" type="text" class="form-control" name ="agama" class="form-control @error('agama') is-invalid @enderror">

                                    <option value="Islam" name ="agama">Islam</option>

                                    <option value="Protestan" name ="agama"> Kristen (Protestan)</option>

                                    <option value="Katolik" name ="agama"> Kristen (Katolik)</option>

                                    <option value="Hindu" name ="agama"> Hindu </option>

                                    <option value="Budha" name ="agama"> Budha</option>

                                    <option value="Konghuchu" name ="agama"> Konghuchu</option>
                                    
                                    <option value="Lainya" name ="agama"> Lainya</option>
                        ...
                        <div class="form-group row">
                            <label for="status" class="col-md-4 col-form-label text-md-right">{{ __('Status Perkawinan') }}</label>

                            <div class="col-md-6">
                            <!--<input id="status" type="text" class="form-control @error('status') is-invalid @enderror" name="status" value="{{ old('status') }}" required autocomplete="agama" autofocus>-->

                            <select id="status" type="text" class="form-control" name ="status">

                                <option value="Kawin" name ="status">Kawin</option>

                                <option value="Belum_Kawin" name ="status">Belum Kawin</option>
                            </select> 
                                @error('status')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
