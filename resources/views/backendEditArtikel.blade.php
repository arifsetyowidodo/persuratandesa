                                    ...
                                    <div class="widget-body">
                                        ...
                                        @foreach($editArtikel as $p)
                                            <div class="form-group row d-flex align-items-center mb-5">
                                                <label class="col-lg-3 form-control-label">ID Artikel</label>
                                                <div class="col-lg-9">
                                                     <td>{{$p->id}}</td>
                                                </div>
                                            </div>
                                            <div class="form-group row d-flex align-items-center mb-5">
                                                <label class="col-lg-3 form-control-label">Judul Artikel</label>
                                                <div class="col-lg-9">
                                                ...
                                                <div class="col-lg-9">
                                                    <form class="form-horizontal">
                                                        <div class="form-group row d-flex align-items-center mt-3 mb-5">
                                                            <label class="col-lg-5 form-control-label">Example</label>
                                                            <div class="col-lg-7">
                                                                <select name ='kategori' class="selectpicker show-menu-arrow show-tick">
                                                                    <option>{{$p->kategori}}</option>
                                                                        @if($p->kategori == Masyarakat)
                                                ...
                                                <div class="col-lg-9">
                                                    <div class="form-group">
                                                        <div class="input-group">
                                                            <input type="text" class="form-control" value=  {{$p->tempat_lahir}}>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group row d-flex align-items-center mb-5">
                                                ...
                                                <div class="col-lg-9">
                                                    <div class="form-group">
                                                        <div class="input-group">
                                                            <input type="date" class="form-control" value=  {{$p->tanggal_lahir}}>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row d-flex align-items-center mb-5">
                                                ...
                                                <div class="col-lg-9">
                                                    <div class="form-group">
                                                        <div class="input-group">
                                                            <input type="text" class="form-control" value=  {{$p->kecamatan}}>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group row d-flex align-items-center mb-5">
                                                ...
                                                <div class="col-lg-9">
                                                    <input type="text" class="form-control" value={{$p->agama}}>
                                            ...
                                            <div class="form-group row d-flex align-items-center mb-5">
                                                ...
                                                <div class="col-lg-9">
                                                    <input type="text" class="form-control" value={{$p->pekerjaan}}>
                                                </div>
                                            </div>
                                            @endforeach
                                            <div class="form-group row d-flex align-items-center mb-5">
                                                ...
                                                <div class="col-lg-9">
                                                    ...
                                                    <a href="/backendUser" class="btn btn-success" >Simpan</a>
                                                </div>
                                            </div>
